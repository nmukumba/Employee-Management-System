        ...
        <div class="row">
            <div class="col-md-6 col-md-offset-3">
                <div class="box box-primary">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form method="post" action="/vacancy/{{ $vacancy[0]->id }}" enctype="multipart/form-data">
                        @csrf
                        @method('PATCH')
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                name="title" 
                                id="title"
                                value="{{ old('title') ?? $vacancy[0]->title }}"
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control {{ $errors->has('company_id') ? ' is-invalid' : '' }}"
                                 ...
                                 @foreach ($companies as $key => $value)
                                    <option value="{{ $key }}" {{ ($key == $vacancy[0]->company_id) ? 'selected' : '' }}> 
                                        {{ $value }} 
                                    </option>
                                @endforeach 
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control {{ $errors->has('department_id') ? ' is-invalid' : '' }}"
                             ...
                             <option value="{{ $key }}" {{ ($key == $vacancy[0]->department_id) ? 'selected' : '' }}> 
                                {{ $value }} 
                            </option>
                            @endforeach 
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group date">
                            ...
                            value="{{ old('closing_date') ?? $vacancy[0]->closing_date }}"
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control {{ $errors->has('status') ? ' is-invalid' : '' }}"
                         ...
                         <option value="{{ $key }}" {{ ($key == $vacancy[0]->status) ? 'selected' : '' }}> 
                            {{ $value }} 
                        </option>
                        @endforeach 
                    </select>
                ...
                <div>
                    <textarea class="textarea {{ $errors->has('description') ? ' is-invalid' : '' }}" 
                        ...
                        {{ old('description') ?? $vacancy[0]->description }}  
                    </textarea>
