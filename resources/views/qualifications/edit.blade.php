            ...
            <div class="row">
                <div class="col-md-6 col-md-offset-3">
                    <div class="box box-primary">
                        ...
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form method="post" action="/qualifications/{{$qualification->id}}" enctype="multipart/form-data">
                            @csrf
                            @method('PATCH')
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    <label for="company_id">Qualification Type</label>
                                    <select class="form-control {{ $errors->has('qualification_type_id') ? ' is-invalid' : '' }}"
                                        ...
                                        @foreach ($types as $key => $value)
                                            <option value="{{ $key }}" {{ ( $key == $qualification->qualification_type_id) ? 'selected' : '' }}> 
                                                        {{ $value }} 
                                            </option>
                                        @endforeach 
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                           ...
                                           name="institution"
                                           id="institution"
                                           value="{{ old('institution') ?? $qualification->institution }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                           ...
                                           name="year_attained"
                                           id="year_attained"
                                           value="{{ old('year_attained') ?? $qualification->year_attained }}"
