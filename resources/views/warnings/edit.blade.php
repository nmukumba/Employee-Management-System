            ...
            <div class="row">
                <div class="col-md-10 col-md-offset-1">
                    <div class="box box-primary">
                        ...
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form method="post" action="/warnings/{{$warning->id}}" enctype="multipart/form-data">
                            @csrf
                            @method('PATCH')
                            <input type="hidden" name="employee_id" value="{{$warning->employee_id}}">
                            <div class="box-body">
                                <div class="row">
                                    <div class="col-md-5">
